...
/**
 * A {@link com.google.common.eventbus.HandlerFindingStrategy} for collecting all event handler methods
 * that are marked with the {@link com.ning.atlas.spi.bus.Subscribe} annotation.
 *
 * @author Cliff Biffle
 */
class AnnotatedHandlerFinder implements HandlerFindingStrategy {
   ...
   * {@inheritDoc}
   *
   * This implementation finds all methods marked with a {@link com.ning.atlas.spi.bus.Subscribe}
   * annotation.
   */
  @Override
   ...
   * {@link com.ning.atlas.bus.AllowConcurrentEvents} annotation.
   *
