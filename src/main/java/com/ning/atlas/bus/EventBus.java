 ...
 * <li>Mark it with a {@link com.ning.atlas.spi.bus.Subscribe} annotation;</li>
 ...
 * later.  (For a convenient way to do this, use an {@link com.ning.atlas.bus.AsyncEventBus}.)
 *
 ...
 * bearing the {@link com.ning.atlas.bus.AllowConcurrentEvents} annotation.  If this annotation is
 ...
 * they are wrapped in an instance of {@link com.ning.atlas.bus.DeadEvent} and reposted.
 *
...
public class EventBus  {
   ...
   * only the {@link com.google.common.eventbus.AnnotatedHandlerFinder} is supported, but this is
   ...
   * {@code event} is not already a {@link com.ning.atlas.bus.DeadEvent}, it will be wrapped in a
